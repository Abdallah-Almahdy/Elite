...
@section('content')
    ...
    <body x-data="{ page: 'saas', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
    $watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'dark bg-gray-900': darkMode === true }">
                            ...
                            <div
                                    ...
                                    <div class="flex gap-x-3.5">
                                        ...
                                        <div>
                                            <button
                                                ...
                                                <span class="hidden sm:block">فلترة</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <div
                                        ...
                                        <span class="text-sm text-gray-500 dark:text-gray-400"> إجمالي الدخل</span>
                                    ...
                                    <div
                                        ...
                                        <span class="text-sm text-gray-500 dark:text-gray-400"> عدد العملاء</span>
                                        <div class="mt-2 flex items-end gap-3">
                                            <h4
                                                class="text-title-xs sm:text-title-sm font-bold text-gray-800 dark:text-white/90">
                                                9,528
                                        ...
                                        <div class="grid gap-5 sm:gap-6 lg:grid-cols-2">
                                            <div
                                                ...
                                                <div class="flex justify-between">
                                                    <div>
                                                        <h3
                                                            class="text-title-xs font-semibold text-gray-800 dark:text-white/90">
                                                            4.26%
                                                        </h3>
                                            ...
                                            <div
                                                ...
                                                <div class="mb-6 flex justify-between">
                                                    <div>
                                                        ...
                                                        <p class="text-theme-sm mt-1 text-gray-500 dark:text-gray-400">
                                                            التسجيلات الجديدة (الموقع + التطبيق المحمول)
                                                        </p>
                                                    </div>
                                                    <div x-data="{ openDropDown: false }" class="relative h-fit">
                                                        <button @click="openDropDown = !openDropDown"
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <div x-show="selected === 'daily'" class="space-y-4">
                                                    <div
                                                        ...
                                                        <div class="px-5">
                                                            <span
                                                                class="block text-sm text-gray-500 dark:text-gray-400">منتج
                                                                رقمي</span>
                                                    ...
                                                    <div
                                                        class="rounded-xl border border-gray-100 px-5 py-4 dark:border-gray-800">
                                                        <div class="mb-3 flex items-start justify-between">
                                                            <div>
                                                                <span
                                                                    class="text-theme-sm font-medium text-gray-500 dark:text-gray-400">متوسط
                                                                    المبيعات اليومية</span>
                                                                <h3
                                                                    class="text-title-sm font-semibold text-gray-800 dark:text-white/90">
                                                                    $2,950
                                                                </h3>
                                                            </div>
                                                            <div>
                                                ...
                                                <div x-show="selected === 'online'" class="space-y-4">
                                                    <div
                                                        ...
                                                        <div class="px-5">
                                                            <span
                                                                class="block text-sm text-gray-500 dark:text-gray-400">Digital
                                                                Product</span>
                                                            <div class="mt-1 flex items-center gap-2">
                                                                <span
                                                                    class="bg-success-50 dark:bg-success-500/15 text-success-600 inline-flex size-5 items-center justify-center rounded-full">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="mb-3 flex items-start justify-between">
                                                            <div>
                                                                <span
                                                                    class="text-theme-sm font-medium text-gray-500 dark:text-gray-400">إجمالي
                                                                    المبيعات الاونلاين</span>
                                                                <h3
                                                                    class="text-title-sm font-semibold text-gray-800 dark:text-white/90">
                                                                    $59,410
                                                                </h3>
                                                        ...
                                                        <!-- Chart -->
                                                        <div class="custom-scrollbar max-w-full overflow-x-auto">
                                                            <div id="chartNineteen" class="-ml-3 w-full"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div x-show="selected === 'new'" class="space-y-4">
                                                    <div
                                                        ...
                                                        <div class="px-5">
                                                            <span
                                                                class="block text-sm text-gray-500 dark:text-gray-400">تمت
                                                                إضافتها الشهر الماضي</span>
                                                            <div class="mt-1 flex items-center gap-2">
                                                                <h4
                                                                    class="text-xl font-semibold text-gray-800 dark:text-white/90">
                                                                    8,490
                                            ...
                                            <div class="relative mb-6 flex">
                                                ...
                                                <div class="ml-4">
                                                    <div class="mb-1 flex items-center gap-1">
                                                        <svg width="18" height="18" viewBox="0 0 18 18"
                                                            ...
                                                            <path
                                                                ...
                                                                stroke="#12B76A" stroke-width="1.5"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                        <p class="text-theme-xs text-success-500 font-medium">New invoice
                                                        </p>
                                                    </div>
                                                    <div class="flex items-baseline">
                                                        ...
                                                        <span
                                                            class="text-theme-sm ml-2 font-normal text-gray-500 dark:text-gray-400">created
                                                            invoice</span>
                                                    </div>
                                            ...
                                            <div class="relative mb-6 flex">
                                                ...
                                                <div class="ml-4">
                                                    <div class="flex items-baseline">
                                                        ...
                                                        <span class="ml-2 text-sm text-gray-500 dark:text-gray-400">created
                                                            فاتورة البيع</span>
                                                    </div>
                                                    <p class="text-theme-sm font-normal text-gray-500 dark:text-gray-400">
                                                        HK-234G
                                            ...
                                            <div class="relative mb-6 flex">
                                                ...
                                                <div class="ml-4">
                                                    <div class="flex items-baseline">
                                                        ...
                                                        <span
                                                            class="text-theme-sm ml-2 text-gray-500 dark:text-gray-400">created
                                                            invoice</span>
                                                    </div>
                                                    <p class="text-theme-sm font-normal text-gray-500 dark:text-gray-400">
                                                        LH-2891C
        ...
        <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
            ...
            data-cf-beacon='{"rayId":"97ae34d48d730488","version":"2025.8.0","r":1,"token":"67f7a278e3374824ae6dd92295d38f77","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}}}'
            crossorigin="anonymous"></script>
    </body>


    <script data-cfasync="false" nonce="7fed6eae-101c-4520-a4b3-1a4734eb7848">
        try {
            (function(w, d) {
                ! function(j, k, l, m) {
                    if (j.zaraz) console.error("zaraz is loaded twice");
                        ...
                        j.zaraz._v = "5870";
                        j.zaraz._n = "7fed6eae-101c-4520-a4b3-1a4734eb7848";
                        j.zaraz.q = [];
