    ...
    <table class="table table-hover table-bordered text-center text-nowrap">
        <thead class="bg-blue-200">
            <tr>
                ...
                <th scope="col">حد الائتمان</th>
                <th scope="col">نقاط المكافآت</th>
        ...
        <tbody>
            @forelse ($customers as $customer)
                <tr>
                    <td>{{ $customer->name }}</td>
                    <td>{{ $customer->customer_type == 'retail' ? 'تجزئة' : 'جملة' }}</td>
            ...
            @empty
                <tr>
                    <td colspan="6" class="text-center bg-danger">لا يوجد عملاء</td>
                </tr>
            @endforelse
        </tbody>
    </table>
