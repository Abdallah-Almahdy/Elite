...
@section('content')
    ...
    <table class="table table-hover   table-bordered text-center text-nowrap">
        ...
        <tbody>
                        ...
                        <div class="flex justify-center items-center  ">
                            ...
                            @else
                                <span class="relative flex justify-center items-center size-3"> <span
                                    ...
                                    <span class="relative inline-flex size-3 rounded-full bg-green-500"></span></span>
                            @endif
            ...
            @empty
                <td colspan="3 text-center bg-danger">لا يوجد مطابخ</td>
            @endforelse
