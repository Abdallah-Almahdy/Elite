...
export default function SuppliersPermissions() {
  const navigate = useNavigate();
  const { updateScreenSettings } = useInvoiceSettings();
  const { supplierShow, setSupplierShow } = useScreenSettingsPreferenceLogic();

  const settings = [
    {
      label: "السماح بعرض شاشة الموردين",
      value: supplierShow,
      setter: setSupplierShow,
    },
  ];
