...
export default function ReportsPermissions() {
  const navigate = useNavigate();
  const { updateScreenSettings } = useInvoiceSettings();
  const { reportShow, setReportShow } = useScreenSettingsPreferenceLogic();

  const settings = [
    {
      label: "السماح بعرض التقارير   ",
      value: reportShow,
      setter: setReportShow,
    },
  ];
