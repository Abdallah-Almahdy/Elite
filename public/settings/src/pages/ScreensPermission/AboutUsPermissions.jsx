...
export default function AboutUsPermissions() {
  const navigate = useNavigate();
  const { updateScreenSettings } = useInvoiceSettings();
  const { aboutUsShow, setAboutUsShow } = useScreenSettingsPreferenceLogic();

  const settings = [
    {
      label: "السماح بعرض شاشة عننا",
      value: aboutUsShow,
      setter: setAboutUsShow,
    },
  ];
