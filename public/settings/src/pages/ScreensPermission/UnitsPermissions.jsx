...
export default function UnitsPermissions() {
  const navigate = useNavigate();
  const { updateScreenSettings } = useInvoiceSettings();
  const { unitShow, setUnitShow } = useScreenSettingsPreferenceLogic();

  const settings = [
    { label: "السماح بعرض شاشة الوحدات", value: unitShow, setter: setUnitShow },
  ];
