...
export const FormDataProvider = ({ children }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    warehouseId: savedData?.warehouseId || warehouseId || "",
  ...
  React.useEffect(() => {
    ...
    setFormData((prev) => {
      const updated = {
        ...
        warehouseName: userWarehouseNames.find((wh)=>wh?.is_default === true)?.name ?? draftFormData.warehouseName ?? prev.warehouseName,
        warehouseId: userWarehouseNames.find((wh)=>wh?.is_default === true)?.id ?? draftFormData.warehouseId ?? prev.warehouseId,
      };
      // const updated = {
      //   ...prev,
    ...
    //   return isSame ? prev : updated;
    // });
  }, [draftFormData, invoiceSettings, userWarehouseNames]);
