...
export default function OrderActions() {
  ...
  return (
    <div className="w-full flex gap-x-5 mt-1 text-white">
      ...
      <button
      disabled={!permissions["pos.InviceCancel"]}
        onClick={handleCancel}
        className={`bg-red-600 bg-opacity-80 hover:bg-opacity-95 w-[20%] rounded  flex justify-center items-center gap-2 relative group overflow-hidden ${!permissions["pos.InviceCancel"] ? `cursor-not-allowed` : `cursor-pointer`}`}
      >
        <span>الغاء</span>
