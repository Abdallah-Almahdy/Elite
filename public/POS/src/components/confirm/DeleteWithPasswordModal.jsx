...
export default function DeleteWithPasswordModal({ isOpen, onConfirm, onClose }) {
  ...
  return (
    <div className="fixed inset-0 w-full min-h-screen flex justify-center items-center bg-black/50 z-50">
      <div className="w-[420px] bg-white rounded-2xl shadow-xl p-6 relative">
        ...
        <h2 className="text-xl font-bold text-center mb-2">إدخال كلمة السر </h2>

        <p className="text-sm text-gray-500 text-center mb-6">
          برجاء إدخال كلمة المرور المصرح بها لحذف المنتج
        </p>
