...
export default function InvoiceTypeSettings() {
    ...
    const {defaultInvoiceType, setDefaultInvoiceType, allowedInvoiceType, setAllowedInvoiceType} = useSettingsPreference()

  return (
    <div className='w-full bg-white rounded-lg shadow-lg'>
      <div className='flex items-center border-b'>
        <PiInvoiceBold className='text-2xl text-blue-700 mr-5'/>
        <h1 className=' p-5 pr-2 font-semibold text-xl'>اعدادات الفاتورة الافتراضية</h1>
      </div>
