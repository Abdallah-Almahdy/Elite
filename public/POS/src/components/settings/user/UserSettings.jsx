...
export default function UserSettings() {
    ...
    const {userName, setUserName, errors, setErrors, handleSearchUserName, userNameResult,
         userNameShowResult, setUserNameResult, setUserNameShowResult,
        handleSelectUser} = useUserSettingsPreference();
  ...
  return (
    ...
    if(value.length === 0){
      printerNameError = "يجب اختيار اسم المستخدم";
    }
