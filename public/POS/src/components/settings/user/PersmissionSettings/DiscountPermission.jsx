...
export default function DiscountPermission() {
  const { priceChangeAuth,
        discountAuth,
       setPriceChangeAuth,
        setDiscountAuth} = useUserSettingsPreference();
  return (
    <div>
             ...
             <div className='flex items-center gap-x-1'>
                ...
                <h2 >السماح بتغيير السعر</h2>
                  ...
                  <div className='pt-2 sm:w-[50%]'>
                    <PermissionToggle value={priceChangeAuth} onChange={(val)=>setPriceChangeAuth(val)}/>
                  </div>
        </div>
        <div className='flex justify-between items-center gap-x-10 text-lg p-3 py-0'>
             <div  className='flex items-center gap-x-1'>
                ...
                <h2>السماح بتطبيق تخفيضات </h2>
                  ...
                  <div className='pt-2 sm:w-[50%]'>
                    <PermissionToggle value={discountAuth} onChange={(val)=> setDiscountAuth(val)}/>
                  </div>
        </div>
        <hr className='w-[95%]'/>
    </div>
